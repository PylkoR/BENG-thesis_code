...
# Ścieżki wyjściowe
OUTPUT_PLOT_FULL = os.path.join(SCRIPT_DIR, 'naive_d_forecast_full.png')
OUTPUT_PLOT_ZOOM = os.path.join(SCRIPT_DIR, 'naive_d_forecast_zoom.png')
OUTPUT_PRED_PATH = os.path.join(SCRIPT_DIR, 'naive_d_predictions.csv')
OUTPUT_METRICS_PATH = os.path.join(SCRIPT_DIR, 'naive_d_metrics.csv')
...
try:
    ...
    # 2. Ekstrapolacja pierwszego stopnia jako prognoza
